...
#[[prevL[-1][0] + x[0:1][0] , prevL[1] + x[1:2][1]]], # quadratic bezier curve, relative TODO, fragment                
    ...
    #append the last set of attrubutes of the first element to the lookBack for cases where smooth or smooth quad segments appear at the begining of a path.
